...
<section class="home-main">
    ...
    <div class="banner-slider">
        <div class="home-slider">
            ...
            <div class="item">
                <figure>
                    <img src="<?php echo $images_with_detail['image']['url']; ?>"
                        alt="<?php echo $images_with_detail['image']['alt']; ?>" />
                </figure>
                <div class="content">
                    <div class="container">
        ...
        <div class="container">
            <ul>
                ...
                <li data-aos="fade-up" data-aos-duration="1000" data-aos-easing="linear">
                    <a class="image-hover" href="#gallery-view-<?php echo $index; ?>" rel="modal:open"
                        alt="<?php echo $gallery_detail['category_name']; ?>">
                        <figure>
                            <img src="<?php echo $gallery_detail['image']; ?>"
                                alt="<?php echo $gallery_detail['category_name']; ?>" />
                        </figure>
                    </a>
                    <h2 class="gallery-name" data-aos="fade-up" data-aos-duration="1000">
                        <a href="#gallery-view-<?php echo $index; ?>" rel="modal:open"
                            alt="<?php echo $gallery_detail['category_name']; ?>">
        ...
        <div class="mainpopup">
                ...
                <a href="javascript:;" class="back-arrow">
                    ...
                    <span class="backicon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="5.311" height="9.207" viewBox="0 0 5.311 9.207">
                            <path id="Path_170" data-name="Path 170" d="M0,0,4.25,4.25,8.5,0"
                                transform="translate(4.958 0.354) rotate(90)" fill="none" stroke="#fff"
                                stroke-width="1" />
                        </svg>
                    </span>
                    Back to categories
            ...
            <div class="popupslider">
                <?php
                        ...
                        ?>
                <div class="imagebox">
                    <img src="<?php echo $popup_images_detail['image']; ?>" loading="lazy" height="100%" width="100%"
                        alt="big-img" title="big-img" />
            ...
            <a href="javascript:;" class="next-prev">
                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="165" viewBox="0 0 45 165">
                    <g id="Group_127" data-name="Group 127" transform="translate(-1327.5 -735.5)">
                        <path id="Path_167" data-name="Path 167" d="M0,0,4.25,4.25,8.5,0"
                            transform="translate(1352.061 753.907) rotate(90)" fill="none" stroke="#e1ccbf"
                            stroke-width="1" />
                        <circle id="Ellipse_11" data-name="Ellipse 11" cx="22" cy="22" r="22"
                            transform="translate(1372 736) rotate(90)" fill="none" stroke="#e1ccbf" stroke-width="1" />
                        <circle transform="translate(1372 736) rotate(180)" class="another-circle" cx="22" cy="-22"
                            r="22" fill="transparent" stroke="#e1ccbf" stroke-width="1.5" />
                        <line id="Line_137" data-name="Line 137" y2="63" transform="translate(1350.339 837.5)"
                            fill="none" stroke="#e1ccbf" stroke-width="1" />
                        <line id="Line_138" data-name="Line 138" y2="14" transform="translate(1350.339 780.5)"
                            fill="none" stroke="#e1ccbf" stroke-width="1" />
                        <circle id="Ellipse_8" data-name="Ellipse 8" cx="22" cy="22" r="22"
                            transform="translate(1328 838) rotate(-90)" fill="none" stroke="#e1ccbf" stroke-width="1" />
                        <circle transform="translate(1372 736) rotate(0)" class="another-circle-next" cx="-22" cy="80"
                            r="22" fill="transparent" stroke="#e1ccbf" stroke-width="1.5" />
                        <path id="Path_166" data-name="Path 166" d="M0,0,4.25,4.25,8.5,0"
                            transform="translate(1348.214 820.369) rotate(-90)" fill="none" stroke="#e1ccbf"
                            stroke-width="1" />
                    </g>
                </svg>
            </a>
            ...
            <div class="content-outer">
                <div class="stacey-image" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">
                    <figure>
                        ...
                        <img src="<?php echo $about_sec_image['url']; ?>"
                            alt="<?php echo $about_sec_image['alt']; ?>" />
                        <?php }else{ ?>
                        <img src="<?php echo $placeholder_image['url']; ?>"
                            alt="<?php echo $placeholder_image['alt']; ?>" />
                        <?php } ?>
                    </figure>
                </div>
                ...
                <div class="item">
                    <div class="eventdetails">
                        <div class="event-content">
                            ...
                            <div class="link">
                                <a href="<?php echo $event_detail['button_url']; ?>"
                                    target="_blank"><?php echo $event_detail['button_text']; ?></a>
                            </div>
                        </div>
                        <div class="event-image">
                            <figure>
                                <img src="<?php echo get_template_directory_uri(); ?>/images/event-image.jpg"
                                    alt="Event Image" />
                            </figure>
                        </div>
                    </div>
                ...
                <a href="javascript:;" class="prev-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="61" height="61" viewBox="0 0 61 61">
                        <g id="Group_124" data-name="Group 124" transform="translate(-998.5 -2901.5)">
                            <path id="Path_168" data-name="Path 168" d="M-8393.963,3931.66l6.543,6.542,6.542-6.542"
                                transform="translate(-2905.514 -5456.255) rotate(-90)" fill="none" stroke="#e1ccbf"
                                stroke-width="1" />
                            <circle id="Ellipse_12" data-name="Ellipse 12" cx="30" cy="30" r="30"
                                transform="translate(999 2962) rotate(-90)" fill="none" stroke="#e1ccbf"
                                stroke-width="1" />
                            <circle transform="translate(999 2962) rotate(0)" class="another-circle" cx="30" cy="-30"
                                r="30" fill="transparent" stroke="#e1ccbf" stroke-width="1.5" />
                        </g>
                    </svg>
                </a>
